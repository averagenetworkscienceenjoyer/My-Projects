...
class CameraApp(App):
    #need to convert this into python instead of kv!!!!
    Builder.load_string('''
<CameraClick>:
...
''')
    ...
    def capture(self, instance):
        ...
        '''
        camera_click_widget = self.picture_layout  # Get a reference to the CameraClick widget
        camera = camera_click_widget.ids['camera']
    ...
    def build(self):
        ...
        take_picture_button = Button(text="take a picture", on_press=self.capture)
